...
const Home = () => {
  const infoCards = [
    ...
    { title: 'Gaming', description: "After coding, gaming is probably one of my biggest hobby. Over the years I have played a TON of insanely well-made games. Some games which have had a lasting impression on me or just gave me some new experiences. I will present to you my selection of games which I consider masterpieces, and if you are a fan of the respective genre, a must-play!", type: 'info' },
  ...
  const imageCards = [
    ...
    { imageUrl: '/astroneer_5.jpg', height: 225, buttonLabel: 'Favorite Games', buttonUrl: '/gaming', type: 'image' },
